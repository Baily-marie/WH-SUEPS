...
for iFile in inputFiles:
    ...
    muon_below27 = 0
    electron_below32 = 0
    events_remaining_after_ref_cut = 0
    events_remaining_after_hlt_cut = 0
    leading_lepton_found = 0
    leading_jet_found = 0
    lepton_cut_passed = 0
    hlt_path_status = {hltpath: 0 for hltpath in hlt}
...
#        if(iEv % 100000 == 0): break
        ...
        if data == "data" and not passRefCut(ev, era, lumi_mask_func):
            continue
        events_remaining_after_ref_cut += 1

...
for x in range(1, int(NumberOfJobs) + 1):
    ...
    with open(f'exec{tag}/job_{x}.sh', 'w') as fout:
        ...
        fout.write(f"echo 'cp output_{x}.root /path/to/your/local/directory/output_{x}.root'\n")
        fout.write(f"cp output_{x}.root /path/to/your/local/directory/output_{x}.root\n")

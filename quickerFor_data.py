...
if data == "data":
    if era == "2016":
        ...
        lumi_mask_func = load_lumi_mask("/afs/cern.ch/user/b/bmay/Cert_314472-325175_13TeV_Legacy2018_Collisions18_JSON.txt")
    else:
...
#        passmtCut = 30 < mT  < 130
        ...
        if etaOption == "Eta":
            ...
            for var in histBins:
                ...
                fillvar = None
                if var == "lep1pt":
                    passDen = passes_lepton_cuts(ev, lepton, highest_pt_lepton_index) and passmetCut
                    fillvar = highest_pt
                elif var == "MET":
                    passDen = passes_lepton_cuts(ev, lepton, highest_pt_lepton_index) and passlepCut
                    fillvar = ev.MET_pt
                elif var == "mT":
                    passDen = passes_lepton_cuts(ev, lepton, highest_pt_lepton_index) and passlepCut and passmetCut
                    fillvar = mT
                elif var == "lep1phi":
                    passDen = passes_lepton_cuts(ev, lepton, highest_pt_lepton_index) and passmetCut and passlepCut
                    fillvar = lepton_phi
                elif var == "MET phi":
                    passDen = passes_lepton_cuts(ev, lepton, highest_pt_lepton_index) and passmetCut and passlepCut
                    fillvar = ev.MET_phi
